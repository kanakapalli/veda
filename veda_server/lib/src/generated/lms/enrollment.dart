...
abstract class Enrollment
  ...
  static EnrollmentInclude include({_i2.AuthUserInclude? user}) {
    return EnrollmentInclude._(user: user);
  }
...
class EnrollmentUpdateTable extends _i1.UpdateTable<EnrollmentTable> {
  ...
  _i1.ColumnValue<_i3.Course, _i3.Course> course(_i3.Course? value) =>
      _i1.ColumnValue(
        table.course,
        value,
      );
...
class EnrollmentTable extends _i1.Table<int?> {
  EnrollmentTable({super.tableRelation}) : super(tableName: 'enrollments') {
    ...
    course = _i1.ColumnSerializable<_i3.Course>(
      'course',
      this,
    );
  ...
  /// Parent course reference
  late final _i1.ColumnSerializable<_i3.Course> course;
...
class EnrollmentInclude extends _i1.IncludeObject {
  EnrollmentInclude._({_i2.AuthUserInclude? user}) {
    _user = user;
  }
...
class EnrollmentAttachRowRepository {
  ...
  /// Creates a relation between the given [Enrollment] and [AuthUser]
  /// by setting the [Enrollment]'s foreign key `userId` to refer to the [AuthUser].
  Future<void> user(
    _i1.Session session,
