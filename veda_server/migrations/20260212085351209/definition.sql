...
--
-- Class CourseIndex as table course_indices
--
...
--
-- Class ModuleProgress as table module_progress
--
...
--
-- Class VedaUserProfile as table veda_user_profile
--
CREATE TABLE "veda_user_profile" (
    ...
    "subscriptionExpiryDate" timestamp without time zone,
...
--
-- Foreign relations for "course_indices" table
--
...
--
-- Foreign relations for "module_items" table
--
...
--
-- Foreign relations for "module_progress" table
--
...
--
-- Foreign relations for "modules" table
--
...
--
-- Foreign relations for "veda_user_profile" table
--
