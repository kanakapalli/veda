...
import 'live/live_message.dart' as _i8;
import 'live/live_session_config.dart' as _i9;
import 'lms/course.dart' as _i10;
import 'lms/course_index.dart' as _i11;
import 'lms/course_visibility.dart' as _i12;
import 'lms/knowledge_file.dart' as _i13;
import 'lms/module.dart' as _i14;
import 'lms/module_item.dart' as _i15;
import 'lms/topic.dart' as _i16;
import 'profiles/user_profile.dart' as _i17;
import 'profiles/user_profile_with_email.dart' as _i18;
...
import 'package:veda_client/src/protocol/lms/module.dart' as _i21;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.LiveMessage) {
      return _i8.LiveMessage.fromJson(data) as T;
    }
    if (t == _i9.LiveSessionConfig) {
      return _i9.LiveSessionConfig.fromJson(data) as T;
    }
    if (t == _i10.Course) {
      return _i10.Course.fromJson(data) as T;
    }
    if (t == _i11.CourseIndex) {
      return _i11.CourseIndex.fromJson(data) as T;
    }
    if (t == _i12.CourseVisibility) {
      return _i12.CourseVisibility.fromJson(data) as T;
    }
    ...
    if (t == _i16.Topic) {
      return _i16.Topic.fromJson(data) as T;
    }
    if (t == _i17.VedaUserProfile) {
      return _i17.VedaUserProfile.fromJson(data) as T;
    }
    if (t == _i18.VedaUserProfileWithEmail) {
      return _i18.VedaUserProfileWithEmail.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i8.LiveMessage?>()) {
      return (data != null ? _i8.LiveMessage.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i9.LiveSessionConfig?>()) {
      return (data != null ? _i9.LiveSessionConfig.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i10.Course?>()) {
      return (data != null ? _i10.Course.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i11.CourseIndex?>()) {
      return (data != null ? _i11.CourseIndex.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.CourseVisibility?>()) {
      return (data != null ? _i12.CourseVisibility.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i16.Topic?>()) {
      return (data != null ? _i16.Topic.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i17.VedaUserProfile?>()) {
      return (data != null ? _i17.VedaUserProfile.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i18.VedaUserProfileWithEmail?>()) {
      return (data != null
              ? _i18.VedaUserProfileWithEmail.fromJson(data)
              : null)
          as T;
    }
    ...
    if (t == List<_i11.CourseIndex>) {
      return (data as List)
              .map((e) => deserialize<_i11.CourseIndex>(e))
              .toList()
          as T;
    }
    if (t == _i1.getType<List<_i11.CourseIndex>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i11.CourseIndex>(e))
                    .toList()
    ...
    if (t == List<_i21.Module>) {
      return (data as List).map((e) => deserialize<_i21.Module>(e)).toList()
          as T;
    }
    if (t == List<String>) {
      return (data as List).map((e) => deserialize<String>(e)).toList() as T;
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i8.LiveMessage => 'LiveMessage',
      _i9.LiveSessionConfig => 'LiveSessionConfig',
      _i10.Course => 'Course',
      _i11.CourseIndex => 'CourseIndex',
      _i12.CourseVisibility => 'CourseVisibility',
      _i13.KnowledgeFile => 'KnowledgeFile',
      _i14.Module => 'Module',
      _i15.ModuleItem => 'ModuleItem',
      _i16.Topic => 'Topic',
      _i17.VedaUserProfile => 'VedaUserProfile',
      _i18.VedaUserProfileWithEmail => 'VedaUserProfileWithEmail',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i7.Greeting():
        return 'Greeting';
      case _i8.LiveMessage():
        return 'LiveMessage';
      case _i9.LiveSessionConfig():
        return 'LiveSessionConfig';
      case _i10.Course():
        return 'Course';
      case _i11.CourseIndex():
        return 'CourseIndex';
      case _i12.CourseVisibility():
      ...
      case _i16.Topic():
        return 'Topic';
      case _i17.VedaUserProfile():
        return 'VedaUserProfile';
      case _i18.VedaUserProfileWithEmail():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'LiveMessage') {
      return deserialize<_i8.LiveMessage>(data['data']);
    }
    if (dataClassName == 'LiveSessionConfig') {
      return deserialize<_i9.LiveSessionConfig>(data['data']);
    }
    if (dataClassName == 'Course') {
      return deserialize<_i10.Course>(data['data']);
    }
    if (dataClassName == 'CourseIndex') {
      return deserialize<_i11.CourseIndex>(data['data']);
    }
    if (dataClassName == 'CourseVisibility') {
      return deserialize<_i12.CourseVisibility>(data['data']);
    }
    ...
    if (dataClassName == 'Topic') {
      return deserialize<_i16.Topic>(data['data']);
    }
    if (dataClassName == 'VedaUserProfile') {
      return deserialize<_i17.VedaUserProfile>(data['data']);
    }
    if (dataClassName == 'VedaUserProfileWithEmail') {
      return deserialize<_i18.VedaUserProfileWithEmail>(data['data']);
    }
